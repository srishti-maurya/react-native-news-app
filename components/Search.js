  ...
  return (
    <View style={{ width: "100%", position: "relative" }}>
      <TextInput
        style={{
          ...styles.search,
          backgroundColor: darkTheme ? "#283149" : "lightgrey",
          color: darkTheme ? "#DBEDF3" : "#283149",
        }}
        onChangeText={(text) => handleSearch(text)}
        placeholder="Search for news"
        placeholderTextColor={darkTheme ? "#DBEDF3" : "grey"}
      />
        ...
        {searchResults.slice(0, 10).map((n) => (
          ...
          >
            <Text
              style={{
                ...styles.singleResult,
                backgroundColor: darkTheme ? "#283149" : "#DBEDF3",
                color: darkTheme ? "#DBEDF3" : "#283149",
              }}
            >
              {n.title}
      ...
      >
        ...
        >
          <Entypo name="circle-with-cross" size={30} color="#DBEDF3" />
        </TouchableOpacity>
